    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-zinc-50 font-sans dark:bg-black">
      <main>
        ...
        <section className="grid md:grid-cols-[420px_1fr] min-h-[30vh]">
          <div className="container-inner relative bg-[#e8b4c8] overflow-hidden">
            <Image
              src="/Wan.png"
        ...
        {/* Quick Background */}
        <section className="px-6 md:px-16 py-12 md:py-20 max-w-7xl mx-auto bg-[#111]">
          <div className="container-inner">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#2a2520]">
              {[
                ...
                <div
                  key={card.tag}
                  className="bg-[#111] p-6 md:p-10 group relative overflow-hidden"
                >
        ...
        {/* Work Experience */}
        <section className="px-6 md:px-16 py-12 md:py-20 max-w-7xl mx-auto bg-[#0d0d0d]">
          <div className="container-inner">
            <p className="text-[10px] tracking-[.2em] uppercase text-[#e8b4c8] mb-3 font-medium">
              Career
            </p>
          ...
          <div className="container-inner">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#2a2520]">
              {[
                {
                  label: 'Design',
                  skills: myDesignSkills,
                },
                {
                  label: 'Frontend',
                  skills: myFrontendSkills,
                },
                {
                  label: 'Soft Skills',
                  skills: mySoftSkills,
                ...
                <div key={group.label} className="bg-[#111] p-6 md:p-8">
                  <p className="text-[10px] tracking-[.18em] uppercase text-[#e8b4c8] mb-5 font-medium">
                    {group.label}
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-start">
              <div>
                <p className="text-[.82rem] text-[#a89f96] font-light leading-relaxed mb-10 max-w-xs tracking-wide">
                  Have a project in mind or just want to say hello? <br />I
                  ...
                  {[
                    {
                      ...
                      label: `${myGmail}`,
                      href: `https://mail.google.com/mail/?view=cm&to=${myGmail}`,
                    },
                    {
              ...
              <div className="flex flex-col gap-4">
                ...
                <button
                  ...
                  className="self-start mt-1 bg-[#e8b4c8] text-[#4a1528] text-[.7rem] font-medium tracking-[.16em] uppercase px-6 py-2.5 rounded-lg hover:bg-[#f5d0e0] transition-colors duration-200 cursor-pointer disabled:opacity-50"
                >
                  {status === 'sending'
                    ? 'Sending...'
                    : status === 'sent'
                ...
                {status === 'error' && (
                  <p className="text-[.75rem] text-red-400 font-light">
